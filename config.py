...
# Embeddings dimension.
_C.HEAD_SELECTION.EMB_DIM = 150
# Glove embeddings dimension.
_C.HEAD_SELECTION.GLOVE_EMB_DIM = 50
# Character-Level embeddings dimension.
_C.HEAD_SELECTION.CHAR_EMB_DIM = 0
# Hidden size.
_C.HEAD_SELECTION.HIDDEN_SIZE = 512
# Character-Level hidden size.
_C.HEAD_SELECTION.CHAR_HIDDEN_SIZE = 0
# Number of layers.
_C.HEAD_SELECTION.NUM_LAYERS = 3
# MLP Hidden size.
_C.HEAD_SELECTION.DENSE_MLP_HIDDEN_SIZE = 512
# Drop-out.
_C.HEAD_SELECTION.ENCODER_DROPOUT_RATE = 0.2
# Edge threshold.
_C.HEAD_SELECTION.EDGE_THRESHOLD = 0.6
# Sampling ratio.
_C.HEAD_SELECTION.SAMPLING_RATIO = 3
